...
public class CsvApi : CommonStockApi
{
    public CsvApi(string code, KL_TYPE kType, string? beginDate, string? endDate, AUTYPE autype)
    ...
    {
        throw new NotImplementedException("CSV API needs to be implemented");
    }
